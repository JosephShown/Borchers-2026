                     ...
                     <div class="col-md-9 rem-col">
                                             ...
                                             <ul class="rem-ul-def clearfix with-2-col">
                                                ...
                                                if( have_rows('region_label') ):  
                                                 while( have_rows('region_label') ): the_row(); ?>
                                                   <li>
                                                      <a href="<?php the_sub_field('file'); ?>" target="_blank"><img src="<?php echo site_url();?>/wp-content/themes/borchers-theme/assets/images/file-icon.png" alt="file"></a>
                                                ...
                                                <tbody>
                                                   ...
                                                   if( have_rows('label_table') ): ?>
                                                      ...
                                                      while( have_rows('label_table') ): the_row();
                                                       ...
                                                       ?>
                                                       <tr>
                                                         <th class="text-nowrap" scope="row"><a target="_blank" href="<?php the_sub_field('pdf'); ?>"><?php the_sub_field('label_title'); ?></a></th>
                        ...
                        <div class="tab-pane" id="tab_b1">
                                    ...
                                    <div class="formulation-grp clearfix category-tiles"> 
                                       <?php  if( have_rows('starting_formulation_category') ): $counter = 1;   
                                        ...
                                        <h4 id="sub"><?php the_sub_field('starting_point_formulations_category_name'); ?></h4>
                                          ...
                                          <img src="<?php echo site_url();?>/<?php the_sub_field('starting_point_formulations_category_image'); ?>"></img>
                                          </div>
                                       <?php $counter++; 
                                    endwhile; ?>
                                 <?php endif; ?>
                              ...
                              <div class="formulation-grp formulation-category-container" style="display:none;" id="sft_<?php echo $counter; ?>">
                                 <div class="color_banner" style=" background-image:url(<?php echo site_url();?>/<?php the_sub_field('starting_point_formulations_category_image'); ?>);"></div>
                                 ...
                                 <div class="table-stack-wrap">
                                    <table class="table tablesaw" data-tablesaw-mode="stack" data-tablesaw-hide-empty="">
                                          ...
                                          <?php if( have_rows('item') ): ?>
                                             ...
                                             >
                                                <th class="text-nowrap" scope="row"><a target="_blank" href="<?php the_sub_field('pdf'); ?>"><?php the_sub_field('name'); ?></a></th>
                                    ...
                                    if( have_rows('file_content') ): ?>
                                       <ul class="rem-ul-def clearfix">
                                          ...
                                          while( have_rows('file_content') ): the_row();
                                           ...
                                           ?>
                                           <li>
                                             <a href="<?php the_sub_field('file_link'); ?>" target="_blank"><img src="<?php echo site_url();?>/wp-content/themes/borchers-theme/assets/images/file-icon.png" alt="file"></a>
